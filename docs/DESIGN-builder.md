...
3. **Refined ZCORN**: per parent cell, z-interpolation of the 8 zcorn values onto the sub-pillar lattice (this reproduces exactly the trilinear-map corners of the old per-cell refinement — verified property: identical coordinates for the conforming case).
